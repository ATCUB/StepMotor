...
#define Current_Rated_Current		(3300)		//额定电流(mA)
#define Current_Cali_Current		(500)		//校准电流(mA)

/****************************************  控制器频率配置区  ****************************************/
#define CONTROL_FREQ_HZ			(20000)												//控制频率20k_hz
...
typedef struct{
	...
	int16_t     est_perlap_speed;    //估计单圈速度
